    ...
    return(
        <>
            ...
            <head>
                ...
                <link rel="stylesheet" href="css/media-query-example1.css" />
            </head>

            <body className="punto9">
                <div className="body">
                ...
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Corrupti, ipsum quae veritatis in
                    nihil laudantium labore beatae nulla laborum rem. Error, molestiae eaque quod placeat at. Labore
                    architecto minus accusantium.</p>
                <h2>Box Columns</h2>
                <figure>
